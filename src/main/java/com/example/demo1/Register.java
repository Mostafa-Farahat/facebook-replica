...
emailfeild.clear();
    ...
    public void setPassword(ActionEvent event) {
        password=passwordfeild.getText();
            if (password.isEmpty()){
                showAlert(Alert.AlertType.ERROR, "Invalid password", "password must be at least 5 characters /n please enter the password again");
               passwordfeild.clear();
    ...
    String birthDate1 = getBirth_date();
    public void reg(ActionEvent event) throws IOException {
        ...
        String gender1 = getGender();
        String birthDate1 = getBirth_date();
        Saving.save(username1, email1, password1, phoneNumber1, gender1, birthDate1);
    ...
    private boolean checkFound(String input) {
        String filePath = "AccountsData.txt";
        try (BufferedReader reader = new BufferedReader(new FileReader(filePath))) {
            ...
            showAlert(Alert.AlertType.ERROR,"Error","Error occurred while reading the file: " + e.getMessage());
        }
